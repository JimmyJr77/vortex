...
test('admin completes an actual receipt replacement and recovers a lost signing response',async({page})=>{
 ...
 try{
  ...
  await expect(work.getByLabel('Document acceptance and future-review evidence',{exact:true})).toHaveValue('Unexpired original passport matches the retained receipt.')
