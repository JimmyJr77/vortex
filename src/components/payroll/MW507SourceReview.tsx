...
export default function MW507SourceReview({source}:{source:NativeMW507}){
 ...
 return <section aria-label="Signed Maryland certificate review" className="mt-3 space-y-3 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm">
  ...
  <p>These requirements are not completed by downloading or viewing this certificate. Complete the applicable employer review before applying these choices. Nonresident and other unsupported exemption claims still need their calculation and compliance workflow.</p>
 </section>
}
