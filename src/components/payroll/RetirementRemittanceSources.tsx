...
export default function RetirementRemittanceSources(){
 ...
 return <section aria-label="Retirement contribution reconciliation" className="space-y-3 rounded-xl border border-slate-200 p-4">
  ...
  <p className="text-sm">Review employee deductions and employer contributions from finalized payroll before arranging remittance. Bank payment and allocation file delivery have separate authorization and recovery. Plan receipt and participant allocation still require verification. Delivery remains unverified; these amounts are not a provider balance.</p>
