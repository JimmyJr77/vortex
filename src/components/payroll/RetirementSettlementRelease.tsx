...
export default function RetirementSettlementRelease({id,evidenceKey,onChanged}:{id:string;evidenceKey:string;onChanged:()=>void}){
 ...
 const pending=useRef<Record<string,unknown>|null>(null),path=`/api/admin/payroll/retirement-settlement-authorizations/${id}`
