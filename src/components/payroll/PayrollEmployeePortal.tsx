  ...
  return (
    <div data-payroll-workspace className="min-h-screen bg-slate-100 pb-24">
      ...
      <main className="mx-auto max-w-6xl space-y-5 px-4 py-5 sm:px-6">
        ...
        {view === 'home' ? <PayrollAccountLink mode="link" facilityId={data.employee.facilityId}/> : null}
