...
import { exerciseDosageLabel, exerciseFitnessGoal, exerciseSessionPhaseHint, exerciseTenetLabels, primaryPhaseProfile, whyPreview } from '../../coach/exerciseCard'
...
const emptyFilters: FilterState = { q: '', sport: '', tenet: '', methodology: '', physiology: '', phase: '', orderSlot: '', freshness: false, canBeDaily: false, minImpact: '' }
