        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed mb-6">
              ...
              <span className="font-bold text-vortex-red">Prepare &amp; Access, Explosiveness, Strength, and Body Control</span>.
            </p>
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Each visit develops the whole athlete, with an emphasis and training dose matched to readiness and experience.
              We practice speed with recovery, build full-body strength progressively, and develop movement intelligence
              and resilience throughout. Dedicated tumbling gives athletes coached practice in controlling their bodies in space.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="max-w-4xl text-lg text-gray-300 leading-relaxed">
              <p>
                Our eight tenets define what we develop; purposeful practice and progressive loading define how.
                Sessions follow Prepare &amp; Access → Explosiveness → Strength → Body Control, with balance,
                coordination, movement intelligence and resilience embedded throughout. Athletes earn progressions
                through consistent technique, and coaches adjust effort and recovery to attendance, readiness and other sport demands.
                Games and competition add value when they fit the time and preserve movement quality. We measure progress
                through stronger movement, useful athletic skills, confidence and sustained enjoyment of training.
              </p>
            </div>
          </motion.div>
        </div>
