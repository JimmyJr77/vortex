...
export type I9DifferentPreview={reviewId:string|number;expiresAt:string;previewSha256:string;recordedOn:string;packet:Array<{documentKey:string;documentId?:string|number;sha256:string;pdfBase64:string;pageCount:number}>}
