/** Copied for vortex-gymnastics.com — hub original: src/components/ReadBoard.tsx (same API / database) */
...
import EventAttachedSignup from '../../../components/EventAttachedSignup'
