...
## Federal filing wage comparison follow-up

The isolated candidate now uses reconciled federal reporting wages for IRS Form 941 line 2 and W-2/W-3 box 1 comparisons, including reviewed imported annual detail. It validates native retained income-tax bases and saved historical income-basis reviews. Missing evidence produces an explicit review state rather than gross-pay substitution. Prior federal receipts without the new reporting-basis version remain retained and require review; new receipts require a verified basis. Changing the form clears copied amounts and confirmation.

Authority: [2026 Form 941 instructions, line 2](https://www.irs.gov/instructions/i941) direct employers to amounts included in W-2 box 1; [2026 W-2/W-3 instructions](https://www.irs.gov/instructions/iw2w3) define that reporting field. This is a comparison of specified wage and tax control totals, not verification of every return field or government acceptance. Other existing forms still compare gross control totals pending fuller form-specific evidence. [Maryland UI guidance](https://labor.maryland.gov/unemployment-insurance/employer-agent/tax-rate.shtml) separately requires gross and taxable wages; completing its full report requires both, not an undocumented replacement of the gross comparison with taxable wages.
