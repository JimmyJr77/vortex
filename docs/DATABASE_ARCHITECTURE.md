...
**Output max-velocity cards 11–18 ([113](../backend/migrations/113_coaching_output_max_velocity_cards.sql)):** Rich card v2 for Max-Velocity Exposure cluster (`max_velocity_exposure`, slots 321–325). Equipment taxonomy: `wickets`, `timing_gates`. Validation education: `output_max_velocity_readiness`; workout validator `analyzeOutputMaxVelocityReadiness` in [workoutValidation.js](../backend/platform/workoutValidation.js). Generator: [scripts/generate-113-output-max-velocity-cards.mjs](../scripts/generate-113-output-max-velocity-cards.mjs). Data: [scripts/data/output-max-velocity-cards-11-18.mjs](../scripts/data/output-max-velocity-cards-11-18.mjs).
