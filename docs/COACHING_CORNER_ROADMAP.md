...
**Capacity phase content:** Migration `120` adds six Capacity subroles and 44 fine order slots; `121` seeds 50 thin Capacity movements. Rich pass: `122` (squat / knee-dominant 1–10). Validation education: `capacity_readiness`, `capacity_squat_readiness`; validators `analyzeCapacityReadiness`, `analyzeCapacitySquatReadiness` in [workoutValidation.js](../backend/platform/workoutValidation.js). Generators: [scripts/generate-121-capacity-seed.mjs](../scripts/generate-121-capacity-seed.mjs), [scripts/generate-122-capacity-squat-cards.mjs](../scripts/generate-122-capacity-squat-cards.mjs). Data: [scripts/data/capacity-movements-top-50.mjs](../scripts/data/capacity-movements-top-50.mjs), [scripts/data/capacity-squat-cards-1-10.mjs](../scripts/data/capacity-squat-cards-1-10.mjs).
