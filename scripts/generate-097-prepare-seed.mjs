/**
 * Generates backend/migrations/097_coaching_prepare_and_access_seed.sql
...
const MOVEMENTS = [
  ...
  { name: 'Quadruped Spinal Circles', slug: 'quadruped-spinal-circles', desc: 'Segmental spine circles in quadruped.', family: 'Spinal mobility', subrole: 'mobilize', slot: 'spinal_mobility', focus: 'Segmental spine, lateral flexion, control', joints: ['spine_rotation', 'spine_lateral_flexion'], body: 'spine', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility', 'core_body_control'], phys: ['control_stability'], pattern: 'brace', equip: 'mat', sets: 2, reps: 4, rest: 15, est: 40, unit: 'reps', impact: 0, ageMin: 8, setup: ['Quadruped neutral spine'], steps: ['Draw small circles with spine', 'Reverse direction each rep'], cues: ['Keep shoulders quiet'], faults: ['Shifting weight side to side excessively'] },
  { name: 'Quadruped Thread the Needle', slug: 'quadruped-thread-the-needle', desc: 'Quadruped thoracic rotation reach-under.', family: 'Thoracic rotation', subrole: 'mobilize', slot: 'thoracic_rotation', focus: 'Thoracic rotation, scapular freedom', joints: ['thoracic_rotation', 'shoulder_flexion'], body: 'spine', tenets: ['flexibility', 'body_control'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'rotate', equip: 'mat', sets: 2, reps: 6, rest: 15, est: 35, unit: 'reps', impact: 0, ageMin: 6, setup: ['Quadruped, one hand behind head'], steps: ['Rotate elbow toward opposite wrist', 'Follow with eyes'], cues: ['Rotate through mid-back'], faults: ['Dumping into lumbar spine'] },
  { name: 'Side-Lying Open Book', slug: 'side-lying-open-book', desc: 'Side-lying thoracic rotation with knee anchor.', family: 'Thoracic rotation', subrole: 'mobilize', slot: 'thoracic_rotation', focus: 'Thoracic rotation, rib mobility', joints: ['thoracic_rotation'], body: 'spine', tenets: ['flexibility'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'rotate', equip: 'mat', sets: 2, reps: 6, rest: 15, est: 35, unit: 'reps', impact: 0, ageMin: 6, setup: ['Side-lying, knees bent 90°, arms extended'], steps: ['Open top arm like a book', 'Follow hand with eyes'], cues: ['Keep knees stacked'], faults: ['Rolling hips backward'] },
  { name: 'Inchworm Walkout', slug: 'inchworm-walkout', desc: 'Standing to plank walkout and return.', family: 'Full-body flow', subrole: 'integrate', slot: 'crawl_pattern_prep', focus: 'Hamstrings, shoulders, trunk, plank access', joints: ['shoulder_flexion', 'hip_hinge'], body: 'full_body', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility', 'core_body_control'], phys: ['control_stability', 'force_tissue_capacity'], pattern: 'locomote', equip: 'none', sets: 2, reps: 4, rest: 20, est: 40, unit: 'reps', impact: 0, ageMin: 6, setup: ['Stand feet hip-width'], steps: ['Hinge and place hands on floor', 'Walk out to plank', 'Walk feet to hands and stand'], cues: ['Soft knees if hamstrings tight'], faults: ['Sagging hips in plank'] },
  ...
  { name: 'Short-Foot Drill', slug: 'short-foot-drill', desc: 'Arch doming without toe curl.', family: 'Foot activation', subrole: 'activate', slot: 'foot_activation', focus: 'Foot tripod, arch stiffness', joints: ['foot_supination'], body: 'ankle', tenets: ['body_control', 'strength'], methods: ['isometrics'], phys: ['control_stability'], pattern: 'brace', equip: 'none', sets: 2, reps: 10, rest: 15, est: 25, unit: 'reps', impact: 0, ageMin: 8, setup: ['Single leg balance, foot flat'], steps: ['Shorten foot by pulling ball toward heel', 'Hold 2-3 seconds'], cues: ['Toes stay long'], faults: ['Curling toes under'] },
  { name: 'Foot Tripod Weight Shifts', slug: 'foot-tripod-weight-shifts', desc: 'Weight shifts through heel, big toe, little toe.', family: 'Foot activation', subrole: 'activate', slot: 'foot_activation', focus: 'Foot pressure, balance readiness', joints: ['ankle_inversion', 'ankle_eversion'], body: 'ankle', tenets: ['balance', 'body_control'], methods: ['balance_stability'], phys: ['control_stability', 'perception_action_skill'], pattern: 'brace', equip: 'none', sets: 2, reps: 6, rest: 15, est: 30, unit: 'reps', impact: 0, ageMin: 6, setup: ['Single leg stand'], steps: ['Shift weight to heel, then ball, then edges'], cues: ['Quiet upper body'], faults: ['Hip hiking'] },
  { name: 'Low Pogos', slug: 'low-pogos', desc: 'Low-amplitude ankle bounces.', family: 'Elastic prep', subrole: 'potentiate_bridge', slot: 'low_level_plyo_prep', focus: 'Elastic ankle stiffness, light SSC', joints: ['ankle_plantarflexion'], body: 'ankle', tenets: ['explosiveness', 'coordination'], methods: ['plyometrics', 'neural'], phys: ['ssc_stiffness', 'neural_output_readiness'], pattern: 'jump', equip: 'none', sets: 2, reps: 10, rest: 30, est: 25, unit: 'reps', impact: 2, ageMin: 8, setup: ['Stand tall, soft knees'], steps: ['Small quick bounces off floor', 'Minimal knee bend'], cues: ['Stiff ankles', 'Quiet landings'], faults: ['Deep squatting between reps'] },
  { name: 'Jump Rope Easy Bounce', slug: 'jump-rope-easy-bounce', desc: 'Light rope or mimed bounce for rhythm.', family: 'Rhythm warm-up', subrole: 'raise', slot: 'rhythm_warmup', focus: 'Rhythm, foot/ankle temperature', joints: ['ankle_plantarflexion'], body: 'full_body', tenets: ['coordination', 'speed'], methods: ['neural', 'plyometrics'], phys: ['neural_output_readiness', 'energy_systems_repeatability'], pattern: 'jump', equip: 'none', sets: 2, work: 30, rest: 30, est: 35, unit: 'seconds', impact: 2, ageMin: 6, setup: ['Hold rope or mime bounce'], steps: ['Easy double-foot bounce', 'Stay on balls of feet'], cues: ['Relax shoulders'], faults: ['Jumping too high'] },
  ...
  { name: 'Walking Quad Pull', slug: 'walking-quad-pull', desc: 'Walk with standing quad stretch.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Hip extension, quad length, balance', joints: ['hip_extension', 'knee_flexion'], body: 'hip', tenets: ['flexibility', 'balance'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'locomote', equip: 'none', sets: 2, reps: 10, rest: 15, est: 40, unit: 'reps', impact: 0, ageMin: 6, setup: ['Walk forward'], steps: ['Grab ankle, pull heel to glute', 'Keep knees together'], cues: ['Tall posture'], faults: ['Arching lower back'] },
  { name: 'Leg Swings Front Back', slug: 'leg-swings-front-back', desc: 'Dynamic hip flexion/extension swings.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Hip flexion/extension', joints: ['hip_flexion', 'hip_extension'], body: 'hip', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility', 'neural'], phys: ['control_stability'], pattern: 'locomote', equip: 'none', sets: 2, reps: 10, rest: 15, est: 30, unit: 'reps', impact: 0, ageMin: 8, setup: ['Hold wall for balance'], steps: ['Swing leg forward and back', 'Stay tall, no trunk lean'], cues: ['Control at end range'], faults: ['Throwing leg violently'] },
  { name: 'Leg Swings Lateral', slug: 'leg-swings-lateral', desc: 'Frontal-plane leg swings.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Hip abduction/adduction', joints: ['hip_abduction'], body: 'hip', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'locomote', equip: 'none', sets: 2, reps: 10, rest: 15, est: 30, unit: 'reps', impact: 0, ageMin: 8, setup: ['Face wall, hand support'], steps: ['Swing leg across and out'], cues: ['Pelvis stays square'], faults: ['Rotating trunk'] },
  { name: '90/90 Hip Switch', slug: '9090-hip-switch', desc: 'Seated 90/90 hip internal/external rotation switches.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Hip internal/external rotation', joints: ['hip_rotation'], body: 'hip', tenets: ['flexibility', 'body_control'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'rotate', equip: 'mat', sets: 2, reps: 8, rest: 20, est: 45, unit: 'reps', impact: 0, ageMin: 8, setup: ['Seated 90/90, hands behind for support'], steps: ['Lift knees and switch sides', 'Control the transition'], cues: ['Stay tall'], faults: ['Using momentum to flop'] },
  { name: 'Shin Box Switch', slug: 'shin-box-switch', desc: 'Shin box position hip switches.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Hip rotation, trunk control', joints: ['hip_rotation'], body: 'hip', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility', 'core_body_control'], phys: ['control_stability'], pattern: 'rotate', equip: 'mat', sets: 2, reps: 6, rest: 20, est: 40, unit: 'reps', impact: 0, ageMin: 10, setup: ['Shin box seated'], steps: ['Switch legs to opposite 90/90'], cues: ['Hands light on floor'], faults: ['Collapsing into one hip'] },
  { name: 'Shin Box Get-Up', slug: 'shin-box-get-up', desc: 'Rise from shin box to kneeling or standing.', family: 'Hip integration', subrole: 'integrate', slot: 'full_body_flow', focus: 'Hip rotation to locomotion', joints: ['hip_rotation', 'hip_extension'], body: 'full_body', tenets: ['coordination', 'strength'], methods: ['mobility_flexibility', 'core_body_control'], phys: ['control_stability', 'perception_action_skill'], pattern: 'locomote', equip: 'mat', sets: 2, reps: 4, rest: 30, est: 45, unit: 'reps', impact: 0, ageMin: 10, setup: ['Start in shin box'], steps: ['Rotate and extend to half-kneeling', 'Optional stand'], cues: ['Drive through front foot'], faults: ['Using hands to push off floor'] },
  { name: 'Hip CARs', slug: 'hip-cars', desc: 'Standing or quadruped hip controlled rotations.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Active hip control', joints: ['hip_rotation', 'hip_flexion'], body: 'hip', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'rotate', equip: 'none', sets: 2, reps: 4, rest: 15, est: 35, unit: 'reps', impact: 0, ageMin: 8, setup: ['Stand on one leg or quadruped'], steps: ['Draw slow circles with knee'], cues: ['Keep pelvis still'], faults: ['Trunk sway'] },
  { name: 'Adductor Rockback', slug: 'adductor-rockback', desc: 'Half-kneeling adductor stretch rock.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Adductors, groin, hinge', joints: ['hip_abduction'], tissues: ['adductors'], body: 'hip', tenets: ['flexibility'], methods: ['mobility_flexibility'], phys: ['force_tissue_capacity'], pattern: 'hinge', equip: 'mat', sets: 2, reps: 8, rest: 15, est: 35, unit: 'reps', impact: 0, ageMin: 8, setup: ['Half-kneeling wide stance'], steps: ['Rock toward straight leg side'], cues: ['Flat back'], faults: ['Rounding spine'] },
  { name: 'Frog Rockback', slug: 'frog-rockback', desc: 'Quadruped wide-knee rockback.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Hip abduction, adductor tissue', joints: ['hip_abduction'], tissues: ['adductors'], body: 'hip', tenets: ['flexibility'], methods: ['mobility_flexibility'], phys: ['force_tissue_capacity'], pattern: 'squat', equip: 'mat', sets: 2, reps: 8, rest: 20, est: 40, unit: 'reps', impact: 0, ageMin: 8, setup: ['Quadruped, knees wide'], steps: ['Rock hips back toward heels'], cues: ['Keep spine neutral'], faults: ['Collapsing into low back flexion'] },
  { name: 'Cossack Shift', slug: 'cossack-shift', desc: 'Low-amplitude lateral lunge shift.', family: 'Hip mobility', subrole: 'mobilize', slot: 'hip_mobility', focus: 'Frontal-plane hip/ankle access', joints: ['hip_abduction', 'ankle_dorsiflexion'], body: 'hip', tenets: ['flexibility', 'balance'], methods: ['mobility_flexibility', 'balance_stability'], phys: ['control_stability'], pattern: 'squat', equip: 'none', sets: 2, reps: 6, rest: 20, est: 40, unit: 'reps', impact: 0, ageMin: 10, setup: ['Wide stance, toes forward or slightly out'], steps: ['Shift to one side keeping heel down', 'Alternate sides'], cues: ['Chest up'], faults: ['Heel lifting on bent leg side'] },
  { name: 'Deep Squat Pry', slug: 'deep-squat-pry', desc: 'Hold deep squat and pry knees open.', family: 'Squat access', subrole: 'integrate', slot: 'squat_to_stand', focus: 'Squat bottom, hips, ankles, trunk', joints: ['hip_flexion', 'ankle_dorsiflexion'], body: 'full_body', tenets: ['flexibility', 'body_control'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'squat', equip: 'none', sets: 2, work: 30, rest: 20, est: 35, unit: 'seconds', impact: 0, ageMin: 8, setup: ['Deep squat, elbows inside knees'], steps: ['Pry knees out with elbows', 'Breathe and relax into position'], cues: ['Heels down', 'Chest up'], faults: ['Heels lifting', 'Rounding upper back'] },
  { name: 'Squat-to-Stand with Reach', slug: 'squat-to-stand-with-reach', desc: 'Deep squat hold to stand with overhead reach.', family: 'Squat access', subrole: 'integrate', slot: 'squat_to_stand', focus: 'Hamstrings, squat access, T-spine', joints: ['hip_flexion', 'shoulder_flexion'], body: 'full_body', tenets: ['flexibility', 'coordination'], methods: ['mobility_flexibility'], phys: ['control_stability'], pattern: 'squat', equip: 'none', sets: 2, reps: 6, rest: 20, est: 40, unit: 'reps', impact: 0, ageMin: 6, setup: ['Hold bottom of squat'], steps: ['Reach arms up as you stand', 'Return to squat with control'], cues: ['Weight through mid-foot'], faults: ['Rolling onto toes'] },
  { name: 'Lateral Lunge Shift', slug: 'lateral-lunge-shift', desc: 'Side-to-side lateral lunge patterning.', family: 'Lunge pattern', subrole: 'integrate', slot: 'lunge_pattern_prep', focus: 'Frontal-plane loading, adductors', joints: ['hip_abduction', 'knee_flexion'], body: 'hip', tenets: ['flexibility', 'strength'], methods: ['mobility_flexibility', 'balance_stability'], phys: ['control_stability'], pattern: 'squat', equip: 'none', sets: 2, reps: 6, rest: 20, est: 40, unit: 'reps', impact: 0, ageMin: 8, setup: ['Stand wide'], steps: ['Shift to one side into lateral lunge', 'Drive back to center'], cues: ['Knee tracks over foot'], faults: ['Knee collapsing inward'] },
...
SELECT
  ...
  d.family, 'prepare_and_access', d.subrole, d.slot,
...
sql += MOVEMENTS.map((m) => {
  ...
  return `  (${sqlStr(m.name)}, ${sqlStr(m.slug)}, ${sqlStr(m.desc)}, ${m.ageMin}, ${m.sets}, ${reps ?? 'NULL'}, ${work ?? 'NULL'}, ${m.rest}, ${m.est}, ${sqlStr(summary)}, ${sqlStr(coachLang)}, ${sqlStr(athleteLang)}, ${sqlStr(m.family)}, ${sqlStr(m.subrole)}, ${sqlStr(m.slot)}, ${jsonReq(m).replace('::jsonb', '')}::jsonb, ${jsonExec(m).replace('::jsonb', '')}::jsonb)`
}).join(',\n')
...
UPDATE coaching.exercise SET
  ...
  updated_at = now()
WHERE slug = 'finger-pulses' AND primary_phase_key = 'prepare_and_access';
...
const outPath = path.join(__dirname, '../backend/migrations/097_coaching_prepare_and_access_seed.sql')
