...
function renderReport(flipFit, prescriptionTools) {
  ...
  lines.push(table(['Layer', 'Files', 'Responsibility'], [
    ...
    ['Database schema', '`backend/migrations/750_coaching_flip_fit_schedule.sql`; `backend/migrations/751_coaching_flip_fit_card_references.sql`; `backend/platform/initTables.js`', 'Create and register the facility schedule row and canonical-reference ledger migrations.'],
