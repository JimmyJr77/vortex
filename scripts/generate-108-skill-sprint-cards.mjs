...
let sql = `-- Movement Intelligence sprint mechanics cards 25–34 (rich card v2 content).
...
`
  ...
  sql += `-- ${card.name} (${card.slug})${isAMarch ? ' — dual profile: prepare_and_access primary unchanged' : ''}
