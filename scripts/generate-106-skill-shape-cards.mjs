...
// Optional shape-cluster validation education (phase-level rule remains skill_movement_intelligence_readiness from migration 104).
...
let sql = `-- Skill / Movement Intelligence shape cards 1–10 (rich card v2 content).
