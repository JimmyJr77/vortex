...
export async function reverificationFixture(h){
 const fixture=await employerI9ReviewFixture(h,{authorizedWorker:true}),{api,base,reviewBody}=fixture,pdf=await syntheticI9CopyPdf()
