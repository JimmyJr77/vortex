...
export async function employerI9ReviewFixture(h,{alternative=false}={}){
 const {api,employee,task:employeeTask,signed}=await signedI9Fixture(h,{assisted:false,eVerify:alternative})
 ...
 const initial=await api(base+'/employer-draft?onboardingCycle=1'),draft={documentChoice:'LIST_A',listA:[{title:'U.S. Passport',issuingAuthority:'U.S. Department of State',number:'SYNTHETIC-DOCUMENT',expiresOn:'2030-01-01'}],examinationMethod:alternative?'ALTERNATIVE':'PHYSICAL',firstDayEmployed:'2026-09-01',representativeNameAndTitle:'Reviewer Alice, Hiring Admin',businessName:'Synthetic Employer',businessAddress:'20 Example Road, Bowie, MD 20715'}
