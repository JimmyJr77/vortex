...
export async function signI9SupplementB(db,ctx,taskId,body){
 ...
 const context={today:clock.today,dueOn:root.due_on,originalExaminedOn:review.current.retained.examination.examinedOn,attestationKind:review.current.retained.context.attestationKind,eVerify:review.current.retained.context.eVerify}
