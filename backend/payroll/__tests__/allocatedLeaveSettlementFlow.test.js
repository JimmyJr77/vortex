...
for(const initial of ['HOURLY','SALARY'])test(`${initial}-first allocated paid leave settles across adjacent periods without duplicate pay or worked leave hours`,{skip:!process.env.PAYROLL_TEST_DATABASE_URL},async t=>{
