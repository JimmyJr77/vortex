...
for(const initial of ['HOURLY'])test(`${initial}-first native hourly payroll supplies historical coverage for subsequent salary settlement`,{skip:!process.env.PAYROLL_TEST_DATABASE_URL},async t=>{
