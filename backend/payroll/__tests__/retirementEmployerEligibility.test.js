...
const review=()=>({sourceFingerprint:source.fingerprint,confirmed:true,assessedThrough:'2026-09-11',reference:'Retained reviewed matching and nonelective eligibility.',matching:{status:'ELIGIBLE',eligibleOn:'2026-09-01',vestedBps:0},nonelective:{status:'ELIGIBLE',eligibleOn:'2026-09-01',vestedBps:10000}})
