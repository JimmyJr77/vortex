...
export async function employeePaySetup(db,facility,employee,tasks){
 ...
 else try{calculateWithholding2026({grossPayCents:200000,election:{...election.elections,verified:true},payFrequency:schedule.pay_frequency,year:election.tax_year,workState:employee.work_state,residenceState:employee.residence_state})}catch(e){issues.push(e.message)}
