...
export async function i9DifferentDocumentsBasis(db,ctx,taskId){
 ...
 return {...current,employeeSource,originalSection2:retained.answers,basisHash:hash(JSON.stringify({receiptBasisHash:current.basisHash,employeeDocumentId:employeeSource.documentId,employeeSha256:employeeSource.sha256,employerReviewId:review.id,employerPreviewSha256:review.preview_sha256}))}
}
