-- These landmine rotation, complex, and row baselines omit the exact stance,
-- attachment/handle, path, loading, dosage, fatigue, quality, and stop-rule
-- profiles required for automated selection.
DO $blank_profile_landmine_sources_1425_1440_quarantine$
DECLARE source_id_value INTEGER; definition_id_value UUID;
BEGIN
  FOREACH source_id_value IN ARRAY ARRAY[1425,1426,1429,1430,1431,1432,1433,1435,1437,1439,1440]
  LOOP
  ...
  END LOOP;
END;
$blank_profile_landmine_sources_1425_1440_quarantine$;
