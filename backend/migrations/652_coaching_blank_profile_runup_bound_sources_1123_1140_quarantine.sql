-- These run-up, bound, and jump source cards carry no operational requirements,
-- load, fatigue, dosage, quality, or stop-rule profile. Their labels are
-- preserved for lineage but cannot participate in automated selection.
DO $blank_profile_runup_bound_sources_1123_1140_quarantine$
DECLARE source_id_value INTEGER; definition_id_value UUID;
BEGIN
  FOREACH source_id_value IN ARRAY ARRAY[1123,1124,1129,1131,1134,1139,1140]
  LOOP
  ...
  END LOOP;
END;
$blank_profile_runup_bound_sources_1123_1140_quarantine$;
