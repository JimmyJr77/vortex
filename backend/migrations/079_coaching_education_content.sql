...
INSERT INTO coaching.education_content (entity_type, entity_key, entity_id, title, short_summary, what_it_is, why_it_matters, why_it_goes_here, why_this_order, fatigue_logic, programming_guidance, common_misuse, daily_or_weekly_guidance) VALUES
  ('session_phase', 'prepare_and_access', NULL, 'Prepare & Access',
   'Raise temperature, mobilize joints, activate key tissues, and create access to the positions needed for training.',
   'Prepare & Access raises temperature, mobilizes joints, activates key tissues, and creates access to the positions needed for training.',
  ...
  ('session_phase', 'movement_intelligence', NULL, 'Movement Intelligence',
   'Develop coordination, body shapes, rhythm, mechanics, spatial awareness, and movement literacy before fatigue.',
   'Movement Intelligence develops coordination, body shapes, rhythm, mechanics, spatial awareness, and movement literacy before fatigue.',
  ...
  ('session_phase', 'output', NULL, 'Output',
   'Express high-quality speed, power, elasticity, acceleration, jumping, throwing, and reactive athleticism while fresh.',
   'Output expresses high-quality speed, power, elasticity, acceleration, jumping, throwing, and reactive athleticism while fresh.',
   ...
   'Output belongs before strength and conditioning so speed, stiffness, and intent stay high.',
  ...
  ('session_phase', 'capacity', NULL, 'Capacity',
   'Build strength, force production, tissue tolerance, and structural reserve through loaded and progressive work.',
   'Capacity builds strength, force production, tissue tolerance, and structural reserve through loaded and progressive work.',
   ...
   'Strength work accumulates systemic and local fatigue; still tolerates more than speed or plyometrics.',
  ...
  ('session_phase', 'resilience', NULL, 'Resilience',
   'Build control, stability, landing mechanics, braking ability, joint ownership, trunk control, and tissue durability.',
   'Resilience builds control, stability, landing mechanics, braking ability, joint ownership, trunk control, and tissue durability.',
   ...
   'Hard isometrics and eccentrics create local tissue stress; moderate fatigue is acceptable here.',
  ...
  ('session_phase', 'sustained_capacity', NULL, 'Sustained Capacity',
   'Build the ability to repeat useful athletic work under fatigue while maintaining quality, posture, and safe mechanics.',
   'Sustained Capacity builds the ability to repeat useful athletic work under fatigue while maintaining quality, posture, and safe mechanics.',
   ...
   'Conditioning intentionally accumulates fatigue; athletes should expect elevated heart rate and reduced freshness.',
  ...
  ('session_phase', 'restore', NULL, 'Restore',
   'Downshift the nervous system, restore breathing, reduce tension, recover range, and support readiness.',
   'Restore downshifts the nervous system, restores breathing, reduces tension, recovers range, and supports readiness.',
   ...
   'Downshift the nervous system; this phase should lower arousal, not create new stress.',
...
INSERT INTO coaching.education_content (entity_type, entity_key, entity_id, title, what_it_is, programming_guidance, common_misuse, fatigue_logic) VALUES
  ...
  ('methodology', 'hiit', NULL, 'HIIT', 'High-intensity intervals for conditioning and repeatability.', 'Primary: Sustained Capacity.', 'HIIT before skill, speed, plyometrics, or advanced tumbling.', 'Creates fatigue on purpose; almost always late.')
ON CONFLICT (entity_type, entity_key) WHERE entity_id IS NULL DO UPDATE SET
  title = EXCLUDED.title,
  what_it_is = EXCLUDED.what_it_is,
  programming_guidance = EXCLUDED.programming_guidance,
