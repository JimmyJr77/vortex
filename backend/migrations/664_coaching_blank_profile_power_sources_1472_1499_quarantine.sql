-- These cable, carry, cutting, and plyometric source baselines omit the exact
-- setup, direction, contact, distance, loading, dosage, fatigue, quality, and
-- stop-rule profiles required for workout generation.
DO $blank_profile_power_sources_1472_1499_quarantine$
DECLARE source_id_value INTEGER; definition_id_value UUID;
BEGIN
  FOREACH source_id_value IN ARRAY ARRAY[1472,1473,1474,1476,1481,1485,1486,1487,1490,1491,1496,1498,1499]
  LOOP
  ...
  END LOOP;
END;
$blank_profile_power_sources_1472_1499_quarantine$;
