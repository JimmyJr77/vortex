...
export function goldenCard(phaseKey, index = 1, overrides = {}) {
  ...
  return {
    ...
    difficulty: {
      ...
      relativeStrengthDemand: phaseKey === 'capacity' ? 45 : 20,
      absoluteLoadDemand: 10,
      mobilityDemand: 25,
      balanceDemand: 25,
      stabilityDemand: 30,
      coordinationDemand: 35,
      speedDemand: phaseKey === 'output' ? 55 : 20,
      decisionDemand: 20,
      workCapacityDemand: phaseKey === 'sustained_capacity' ? 55 : 30,
      impact: phaseKey === 'output' && index === 1 ? 55 : 20,
      eccentricTissueStress: 25,
      jointStress: 20,
      spinalLoading: 10,
      gripDemand: 10,
      inversionDemand: 1,
      fearConfidenceBarrier: 10,
      supervisionDemand: 25,
      spottingDemand: 10,
