...
export type ProgrammingModelRole = 'director' | 'athlete_development' | 'methodology_consultant' | 'session_builder' | 'prepare_access' | 'programming_critic' | 'exercise_creator'
