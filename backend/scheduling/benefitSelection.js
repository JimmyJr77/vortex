 ...
 * program / class from Pricing → Costs.
 */
...
const SCOPE_PRIORITY = { class: 2, program: 1 }

/**
 * Collect selections from class → program (most specific wins per benefit).
 */
export async function resolveBenefitSelectionsForLine(pool, { programId, formId }) {
  const scopeQueries = []
