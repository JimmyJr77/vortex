...
export async function sendDemotionEmail({
  ...
  const subject = `Waitlist update for ${title} — Vortex Athletics`

  const text = `Hi ${firstName},

Due to a capacity change for your session, you have been moved to the waitlist.
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #222; max-width: 560px;">
  ...
  <p>Due to a capacity change for your session, you have been moved to the <strong>waitlist</strong>.</p>
